 ...
 *  AD TOUCH
 *--------------*/
#ifndef USE_GAPI_DISPLAY
#  define USE_GAPI_DISPLAY        1
#endif
...
#if USE_GAPI_DISPLAY
/*No settings*/
#include "lv_drivers/display/display.h"
#endif

/*---------------------------------------
 * Mouse or touchpad on PC (using GAPI)
 *-------------------------------------*/
#ifndef USE_MOUSE
#  define USE_MOUSE           1
#endif
...
/*-------------------------------------------
 * Mousewheel as encoder on PC (using GAPI)
 *------------------------------------------*/
