...
DECLARE_MONO_DISCRETE_UCHAR2(16);


static  GUI_DATA_CONST  MONO_DISCRETE_CHAR_16  ascii0816[] = 
{
    {
        " ",   
        {
...
GUI_DATA_CONST  MONO_DISCRETE_FONT  my_mono_discrete_ascii = {
    /* .name      = */ "ASC0816",
    #ifdef _LG_FONT_ID_
    /* .id        = */ 1,
    #endif
    /* .width     = */ 8,
    /* .height    = */ 16,
    /* .counter   = */ sizeof(ascii0816)/sizeof(MONO_DISCRETE_CHAR_16),
    /* .mono_char = */ (void *)ascii0816, 
    /* .next      = */ 0
};
